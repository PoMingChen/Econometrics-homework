...
#mlogit.data() 這個函數會將資料轉成long的那個模式。
...
# "shape" "choice" are still the argument in mandatory
#原則上，在做分析前，shape都需要轉成long
...
#只有B區的individual specific variabls 會有intercept。是老師講義的alpha_i - alpha_j，那截據項可以透過設定將其去除。
